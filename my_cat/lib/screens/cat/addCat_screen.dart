...
import 'package:my_cat/screens/choseAdopte.dart';
...
class AddCat extends StatefulWidget {
  ...
  AddCat({super.key, required this.cat, required this.pet});
                          ...
                          child: TextButton(
                            onPressed: () {
                              if (age_controller.value.text == '' ||
                                ...
                                print('current id number: ' +
                                    (widget.cat.length).toString());
